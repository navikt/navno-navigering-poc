...
function NavLogo(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 269 169" {...props}>
      <defs>
        <path id="prefix__a" d="M22.4 43.42V.69H.57v42.73h21.85z" />
      </defs>
      <g fill="none">
        <path
          fill="#c30000"
          d="M125.3 168.94A84.47 84.47 0 11125.34 0a84.47 84.47 0 01-.02 168.94zM0 121.36l17.27-42.73h16.58l-17.24 42.73zm213.04 0l17.05-42.73h9.04l-17.04 42.73z"
        />
